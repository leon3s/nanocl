...
#[derive(
  Component, Debug, Clone, Default, PartialEq, Serialize, Deserialize,
)]
pub struct Ipam {
...
impl ::std::fmt::Display for ServiceSpecRollbackConfigFailureActionEnum {
  fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
    match *self {
      ...
      ServiceSpecRollbackConfigFailureActionEnum::CONTINUE => {
        write!(f, "{}", "continue")
      }
      ServiceSpecRollbackConfigFailureActionEnum::PAUSE => {
        write!(f, "{}", "pause")
      }
    }
  }
...
impl ::std::fmt::Display for ServiceSpecRollbackConfigOrderEnum {
  fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
    match *self {
      ...
      ServiceSpecRollbackConfigOrderEnum::STOP_FIRST => {
        write!(f, "{}", "stop-first")
      }
      ServiceSpecRollbackConfigOrderEnum::START_FIRST => {
        write!(f, "{}", "start-first")
      }
    }
  }
...
impl ::std::fmt::Display for ServiceSpecUpdateConfigFailureActionEnum {
  fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
    match *self {
      ...
      ServiceSpecUpdateConfigFailureActionEnum::CONTINUE => {
        write!(f, "{}", "continue")
      }
      ServiceSpecUpdateConfigFailureActionEnum::PAUSE => {
        write!(f, "{}", "pause")
      }
      ServiceSpecUpdateConfigFailureActionEnum::ROLLBACK => {
        write!(f, "{}", "rollback")
      }
    }
  }
  ...
  fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
    match *self {
      ...
      ServiceUpdateStatusStateEnum::ROLLBACK_STARTED => {
        write!(f, "{}", "rollback_started")
      }
      ServiceUpdateStatusStateEnum::ROLLBACK_PAUSED => {
        write!(f, "{}", "rollback_paused")
      }
...
impl ::std::str::FromStr for ServiceUpdateStatusStateEnum {
  ...
  fn from_str(s: &str) -> Result<Self, Self::Err> {
    match s {
      ...
      "rollback_completed" => {
        Ok(ServiceUpdateStatusStateEnum::ROLLBACK_COMPLETED)
      }
      x => Err(format!("Invalid enum type: {}", x)),
    }
  }
...
impl ::std::fmt::Display for SwarmSpecCaConfigExternalCAsProtocolEnum {
  fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
    match *self {
      ...
      SwarmSpecCaConfigExternalCAsProtocolEnum::CFSSL => {
        write!(f, "{}", "cfssl")
      }
    }
  }
